...
chat_client:  $(SP_LIBRARY_DIR)/libspread-core.a chat_client.o lts_utils.o utils.h update_ll/update_ll.o chat_ll/chat_ll.o like_ll/like_ll.o client_ll/client_ll.o name_ll/name_ll.o
	$(LD) -o $@ chat_client.o lts_utils.o client_ll/client_ll.o update_ll/update_ll.o chat_ll/chat_ll.o like_ll/like_ll.o name_ll/name_ll.o $(SP_LIBRARY_DIR)/libspread-core.a -ldl -lm -lrt -lnsl $(SP_LIBRARY_DIR)/libspread-util.a
