...
chat_server:  $(SP_LIBRARY_DIR)/libspread-core.a chat_server.o lts_utils.o utils.h update_ll/update_ll.o chat_ll/chat_ll.o like_ll/like_ll.o room_ll/room_ll.o
	    $(LD) -o $@ chat_server.o lts_utils.o update_ll/update_ll.o chat_ll/chat_ll.o like_ll/like_ll.o room_ll/room_ll.o $(SP_LIBRARY_DIR)/libspread-core.a -ldl -lm -lrt -lnsl $(SP_LIBRARY_DIR)/libspread-util.a
